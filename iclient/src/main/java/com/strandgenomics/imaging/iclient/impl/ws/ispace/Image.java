...
public class Image  implements java.io.Serializable {
    ...
    private com.strandgenomics.imaging.iclient.impl.ws.ispace.ImageIndex index;
    ...
    public Image(
           double elapsedTime,
           double exposureTime,
           com.strandgenomics.imaging.iclient.impl.ws.ispace.ImageIndex index,
           long timeStamp,
           double x,
           double y,
           double z) {
     ...
     * @return index
     */
    public com.strandgenomics.imaging.iclient.impl.ws.ispace.ImageIndex getIndex() {
        return index;
    }
     ...
     * @param index
     */
    public void setIndex(com.strandgenomics.imaging.iclient.impl.ws.ispace.ImageIndex index) {
        this.index = index;
    }
