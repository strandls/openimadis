...
public class ImageSpaceLoaderServiceLocator extends org.apache.axis.client.Service implements com.strandgenomics.imaging.iclient.impl.ws.loader.ImageSpaceLoaderService {
    ...
    private java.lang.String iLoader_address = "http://localhost:8080/imanage/services/iLoader";
    ...
    public com.strandgenomics.imaging.iclient.impl.ws.loader.ImageSpaceLoader getiLoader(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.strandgenomics.imaging.iclient.impl.ws.loader.ILoaderSoapBindingStub _stub = new com.strandgenomics.imaging.iclient.impl.ws.loader.ILoaderSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.strandgenomics.imaging.iclient.impl.ws.loader.ImageSpaceLoader.class.isAssignableFrom(serviceEndpointInterface)) {
                com.strandgenomics.imaging.iclient.impl.ws.loader.ILoaderSoapBindingStub _stub = new com.strandgenomics.imaging.iclient.impl.ws.loader.ILoaderSoapBindingStub(new java.net.URL(iLoader_address), this);
                _stub.setPortName(getiLoaderWSDDServiceName());
                return _stub;
            }
        }
