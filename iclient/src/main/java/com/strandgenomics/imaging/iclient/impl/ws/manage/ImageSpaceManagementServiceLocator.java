...
public class ImageSpaceManagementServiceLocator extends org.apache.axis.client.Service implements com.strandgenomics.imaging.iclient.impl.ws.manage.ImageSpaceManagementService {
    ...
    private java.lang.String iManage_address = "http://localhost:8080/imanage/services/iManage";
    ...
    public com.strandgenomics.imaging.iclient.impl.ws.manage.ImageSpaceManagement getiManage() throws javax.xml.rpc.ServiceException {
    ...
    public com.strandgenomics.imaging.iclient.impl.ws.manage.ImageSpaceManagement getiManage(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.strandgenomics.imaging.iclient.impl.ws.manage.IManageSoapBindingStub _stub = new com.strandgenomics.imaging.iclient.impl.ws.manage.IManageSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.strandgenomics.imaging.iclient.impl.ws.manage.ImageSpaceManagement.class.isAssignableFrom(serviceEndpointInterface)) {
                com.strandgenomics.imaging.iclient.impl.ws.manage.IManageSoapBindingStub _stub = new com.strandgenomics.imaging.iclient.impl.ws.manage.IManageSoapBindingStub(new java.net.URL(iManage_address), this);
                _stub.setPortName(getiManageWSDDServiceName());
                return _stub;
            }
        }
