...
public class ImageSpaceSearchServiceLocator extends org.apache.axis.client.Service implements com.strandgenomics.imaging.iclient.impl.ws.search.ImageSpaceSearchService {
    ...
    private java.lang.String iSearch_address = "http://localhost:8080/imanage/services/iSearch";
    ...
    public com.strandgenomics.imaging.iclient.impl.ws.search.ImageSpaceSearch getiSearch() throws javax.xml.rpc.ServiceException {
    ...
    public com.strandgenomics.imaging.iclient.impl.ws.search.ImageSpaceSearch getiSearch(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.strandgenomics.imaging.iclient.impl.ws.search.ISearchSoapBindingStub _stub = new com.strandgenomics.imaging.iclient.impl.ws.search.ISearchSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.strandgenomics.imaging.iclient.impl.ws.search.ImageSpaceSearch.class.isAssignableFrom(serviceEndpointInterface)) {
                com.strandgenomics.imaging.iclient.impl.ws.search.ISearchSoapBindingStub _stub = new com.strandgenomics.imaging.iclient.impl.ws.search.ISearchSoapBindingStub(new java.net.URL(iSearch_address), this);
                _stub.setPortName(getiSearchWSDDServiceName());
                return _stub;
            }
        }
