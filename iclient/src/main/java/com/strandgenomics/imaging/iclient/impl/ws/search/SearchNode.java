...
public class SearchNode  implements java.io.Serializable {
    private com.strandgenomics.imaging.iclient.impl.ws.search.SearchCondition[] filters;
    ...
    public SearchNode(
           com.strandgenomics.imaging.iclient.impl.ws.search.SearchCondition[] filters,
           int recordCount) {
     ...
     * @return filters
     */
    public com.strandgenomics.imaging.iclient.impl.ws.search.SearchCondition[] getFilters() {
        return filters;
    }
     ...
     * @param filters
     */
    public void setFilters(com.strandgenomics.imaging.iclient.impl.ws.search.SearchCondition[] filters) {
        this.filters = filters;
    }
