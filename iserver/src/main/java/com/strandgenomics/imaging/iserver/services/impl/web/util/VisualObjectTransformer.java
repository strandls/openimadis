...
public abstract class VisualObjectTransformer<T> {
    ...
    public T encode(VisualObject object) {
        ...
        case POLYGON:
        	return encodePolygon((Polygon) object);  
        case ARROW:
        	return encodeArrow((Arrow) object);          	
        }
        return null;
    }
     ...
     * @return
     */
    protected abstract T encodePolygon(Polygon object);
     ...
     * @return
     */
    protected abstract T encodeArrow(Arrow object);
}
