...
public class ImageSpaceServiceServiceLocator extends org.apache.axis.client.Service implements com.strandgenomics.imaging.iserver.services.ws.ispace.ImageSpaceServiceService {
    ...
    private java.lang.String iSpace_address = "http://localhost:8080/imanage/services/";
    ...
    public com.strandgenomics.imaging.iserver.services.ws.ispace.ImageSpaceService getiSpace(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.strandgenomics.imaging.iserver.services.ws.ispace.ISpaceSoapBindingStub _stub = new com.strandgenomics.imaging.iserver.services.ws.ispace.ISpaceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.strandgenomics.imaging.iserver.services.ws.ispace.ImageSpaceService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.strandgenomics.imaging.iserver.services.ws.ispace.ISpaceSoapBindingStub _stub = new com.strandgenomics.imaging.iserver.services.ws.ispace.ISpaceSoapBindingStub(new java.net.URL(iSpace_address), this);
                _stub.setPortName(getiSpaceWSDDServiceName());
                return _stub;
            }
        }
