...
public class Archive  implements java.io.Serializable {
    ...
    private com.strandgenomics.imaging.iserver.services.ws.loader.SourceFile[] sourceFiles;
    ...
    public Archive(
           ...
           com.strandgenomics.imaging.iserver.services.ws.loader.SourceFile[] sourceFiles) {
           this.name = name;
     ...
     * @return sourceFiles
     */
    public com.strandgenomics.imaging.iserver.services.ws.loader.SourceFile[] getSourceFiles() {
        return sourceFiles;
    }
     ...
     * @param sourceFiles
     */
    public void setSourceFiles(com.strandgenomics.imaging.iserver.services.ws.loader.SourceFile[] sourceFiles) {
        this.sourceFiles = sourceFiles;
    }
