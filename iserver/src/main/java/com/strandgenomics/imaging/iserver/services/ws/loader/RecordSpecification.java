...
public class RecordSpecification  implements java.io.Serializable {
    private com.strandgenomics.imaging.iserver.services.ws.loader.Channel[] customChannels;

    private com.strandgenomics.imaging.iserver.services.ws.loader.RecordSite[] siteToMerge;

    public RecordSpecification() {
    }

    public RecordSpecification(
           com.strandgenomics.imaging.iserver.services.ws.loader.Channel[] customChannels,
           com.strandgenomics.imaging.iserver.services.ws.loader.RecordSite[] siteToMerge) {
     ...
     */
    public com.strandgenomics.imaging.iserver.services.ws.loader.Channel[] getCustomChannels() {
        return customChannels;
    }
     ...
     */
    public void setCustomChannels(com.strandgenomics.imaging.iserver.services.ws.loader.Channel[] customChannels) {
        this.customChannels = customChannels;
    }
     ...
     * @return siteToMerge
     */
    public com.strandgenomics.imaging.iserver.services.ws.loader.RecordSite[] getSiteToMerge() {
        return siteToMerge;
    }
     ...
     * @param siteToMerge
     */
    public void setSiteToMerge(com.strandgenomics.imaging.iserver.services.ws.loader.RecordSite[] siteToMerge) {
        this.siteToMerge = siteToMerge;
    }
