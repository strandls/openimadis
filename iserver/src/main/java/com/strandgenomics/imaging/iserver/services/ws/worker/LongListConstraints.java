...
public class LongListConstraints  extends com.strandgenomics.imaging.iserver.services.ws.worker.Constraints  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:iworkers", "LongListConstraints"));
