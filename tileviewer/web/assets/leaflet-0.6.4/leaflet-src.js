...
L.TileLayer = L.Class.extend({
	...
	checkTileReady: function(url, tile, tilePoint){
		var _this=this;
		$.ajax({url:url,success:function(result){
			if(typeof result['status']==='undefined'){
				
				var tileurl = _this.getTileUrl(tilePoint);
				
				tile.onerror=function(){
					setTimeout(_this.checkTileReady(url, tile, tilePoint),1000);
				};	
				...
				delete _this._tiles[tilePoint.x+":"+tilePoint.y];

				if(_this._tileShouldBeLoaded(tilePoint) && _this._map._zoom=== tilePoint.z){
					_this._tiles[tilePoint.x+":"+tilePoint.y]= tile;
					_this._loadTile(tile, tilePoint);
				}
			}
		}});
	},
	...
	_loadTile: function (tile, tilePoint) {
		...
		this.checkTileReady(url,tile, tilePoint);
	},
