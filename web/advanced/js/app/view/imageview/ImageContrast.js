 ...
 */
Ext.define('Manage.view.imageview.ImageContrast', {
        ...
        Ext.apply (this, {
            items : [{
                ...
                items : [this.maxSlider, {
                    ...
                    html : '<div id="contrastDraw'+this.channelNo+'" class="editor">' + 
                           '</div>',
                    items : [this.imageCmp]
                }, this.minSlider
                ]
    ...
    listeners : {
        afterrender : function(comp, opts) {
            comp.paper = Raphael("contrastDraw"+this.channelNo, comp.imageWidth, comp.imageHeight);
    ...
    /**
     * Save current contrast settings and exit
     */
