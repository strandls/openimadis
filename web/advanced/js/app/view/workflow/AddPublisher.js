 ...
 */
Ext.define('Manage.view.workflow.AddPublisher', {
            ...
            if (form.isValid()) {
                ...
                form.submit({
                    success: function(form, action) {
                       ...
                       Ext.StoreManager.get('Manage.store.PublisherStore').load(); 
                       view.up().close();
                    },
                    failure: function(form, action) {
                        showErrorMessage(action.response.responseText, "Failed to add new publisher");
                    }
                });
            }
        }
