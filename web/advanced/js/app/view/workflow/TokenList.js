 ...
 */
Ext.define('Manage.view.workflow.TokenList', {
    extend : 'Ext.grid.Panel',
    store : 'Manage.store.workflow.TokenStore',
    xtype : 'tokenList',
    ...
    initComponent : function() {
        ...
        Ext.apply(this, {
            tbar : [{
                ...
                tooltip : 'Add Token',
                handler : function() {
                    this.up('viewTokens').fireEvent("addToken");
                }
            }, {
                ...
                handler : function() {
                    ...
                    if (selected && selected !== null && selected.length === 1) {
                        this.up('viewTokens').fireEvent('editToken', _this, selected[0]);
                    } else {
                ...
                handler : function() {
                    var selected = _this.getSelectionModel().getSelection();
                    if (selected && selected !== null && selected.length === 1) {
                        this.up('viewTokens').fireEvent('removeToken', _this, selected[0]);
                    } else {
