 ...
 */
Ext.define ('Manage.controller.admin.UserAnnotations', {
   ...
   /**
    ...
    onRemoveAnnotation : function(annotation) {
        ...
        Ext.Msg.confirm("Remove", "Are you sure you want to remove " + annotation.data.name + " from the project " + annotation.data.projectName + " ?", 
		function(id) {
		    if (id === "yes") {
			Ext.Ajax.request({
			    method : 'POST',
