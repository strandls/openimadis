 ...
 */
Ext.require(['Manage.view.admin.SplitView']);

Ext.define('Manage.view.admin.ImportLDAPUsers', {
    ...
    items : [
        ...
        leftView : {
            ...
            store : 'admin.availableLDAPUsersStore',
            columns : [
        ...
        rightView : {
            ...
            store : 'admin.selectedLDAPUsersStore',
            columns : [
                {text: "Name", flex : 1, sortable : true, dataIndex : 'name'},
                {text: "E-Mail", flex : 1, sortable : true, dataIndex : 'email', hidden : true}
            ],
